    ...
    constructor() {
        ...
        this.extract = async (videoUrl) => {
            try {
                ...
                const randomCookie = `_ga=GA${Math.floor(Math.random() * 9) + 1}.${Math.floor(Math.random() * 1000000000)}; _gid=GA${Math.floor(Math.random() * 9) + 1}.${Math.floor(Math.random() * 1000000000)}; __cf_bm=${Buffer.from(Math.random().toString())
                    .toString('base64')
